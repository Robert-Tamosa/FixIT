  ...
  const items = [
    {
      ...
      onClick: () => {
        onClose();
        router.push("/dashboard/mechanic/profile/settings/edit");
      },
    },
    {
      label: "Notifications",
      ...
      <div className="relative z-10 w-full p-4 pb-28">
        ...
        <div className="flex flex-col items-center mb-6">
          <div className="relative mb-3">
            ...
            {/* Online indicator */}
            <span
              className={`absolute bottom-1 right-1 w-4 h-4 rounded-full border-2 border-[#080909]
            ...
            {props.yearsExperience !== null && (
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-sm text-zinc-400">
                  {props.yearsExperience} year
                  {props.yearsExperience !== 1 ? "s" : ""} of experience
                </span>
              </div>
            )}
            <div className="flex items-center gap-2.5">
