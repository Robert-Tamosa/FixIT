    ...
    <div
      ...
      {isDone ? (
        ...
        <>
          ...
          {/* Emergency-only: owner's number, front and center — same
              reasoning as ActiveBookingCard's mirror of this: a mechanic
              en route to an emergency shouldn't have to open Messages to
              reach the owner if they're lost or need to confirm access. */}
          {job.isEmergency && job.ownerPhone && (
            <a
