  ...
  const items = [
    {
      ...
      color: "text-zinc-300",
      onClick: () => { onClose(); router.push("/dashboard/shop/profile/edit"); },
    },
    {
      label: "Notifications",
    ...
    >
      <div className="w-full max-w-md rounded-3xl border border-white/[0.08]
        ...
        <div className="px-5 py-3 border-t border-zinc-800/60">
          <p className="text-[11px] text-zinc-700 text-center">FixIT Shop App · v1.0.0</p>
        </div>
      </div>
    </div>
  );
...
function ShareShopLocationButton({ currentAddress }: { currentAddress: string }) {
  ...
  return (
    <div className="mb-4 rounded-2xl border border-white/[0.08] bg-white/[0.03] p-4 space-y-2.5">
      <div>
        <p className="text-xs font-semibold text-zinc-500 uppercase tracking-wide">Shop Location</p>
      ...
      <div className="relative z-10 w-full p-4 pb-28">
          ...
          <div className="flex items-center gap-2 flex-wrap justify-center mb-2">
            ...
            {props.isVerified ? (
              ...
              <span className="text-[11px] font-semibold px-2.5 py-1 rounded-full border
                ...
                {props.verificationStatus === "REJECTED" ? "Verification rejected" : "Verification pending"}
              </span>
            )}
          </div>
          ...
          <div className="space-y-2.5">
            ...
            <div className="flex items-center gap-2.5">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                ...
                <circle cx="12" cy="10" r="3" stroke="#71717A" strokeWidth="1.5" />
              </svg>
        ...
        <div className="mb-4 rounded-2xl border border-white/[0.08] bg-white/[0.03] p-4">
          ...
          <div className="flex flex-wrap gap-2">
            {props.services.length > 0 ? props.services.map((s) => (
              <span key={s}
